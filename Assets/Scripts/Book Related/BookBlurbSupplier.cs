...
//   templates       = { key: genre         -> [BookBlurbTemplate] }
{
    ...
    void BuildDataFromCSV()
    {
        ...
        {
            new BookBlurbTemplate(
                "The asteroids produced a sharp twiny zeeoom as they flew past the spaceship. Commander {mc} gripped the control gear with a tightness that blanched {their} {adj0} fingers. Spotting an asteroid directly in front of the viewport, {they} deftly pulled the controller towards {them} - the ship hulled heavily. {mc} flinched as the asteroid zipped past narrowly above the ship. Phew.\nIt was a stupid miscalculation. An amateur mistake. But, when it came to light-travel, the slightest error in coordinate values resulted in disastrously off-plan warp points. Which is how {mc}’s fleet of space faring {people-p} found themselves in the center of one of the largest asteroid fields she had ever encountered.",
                new List<TemplateSlot>
                {
                    new TemplateSlot("mc", WordType.Name, parentId:"character"),
                    new TemplateSlot("they", WordType.Pronoun, parentId:"character", conjugation:Conjugation.Subject),

...
//   templates       = { key: genre         -> [BookBlurbTemplate] }
{
    ...
    void BuildDataFromCSV()
    {
        ...
        templates.Add("Romance", new List<BookBlurbTemplate>
        {
            ...
            "Romance"),
            new BookBlurbTemplate("The pair made their way through the {place}, admiring the {thing1}s as they passed. {mc_a} struggled to look away from {mc_b}. {they_b} was just so pretty, it's making {them_a} a little crazy, {mc_a} thinks. {they_a} really wants to touch {mc_b}’s {adj1} chestnut hair. And when {they_a} stands just close enough that {mc_b} has to look up at {mc_a}—  god {their_b} eyes. {mc_a} lost {their_a} train of thought every time {mc_b} looked up at {them_a} with those {adj} doe eyes. That’s when {they_a}’d start spewing nonsense and making a fool of {them_a}self; something {they_a} had a natural gift for.",
            new List<TemplateSlot>
            {
                new TemplateSlot("mc_a", WordType.Name, parentId:"character"),
              new TemplateSlot("they_a", WordType.Pronoun, parentId:"character", conjugation:Conjugation.Subject),
        ...
        {
            new BookBlurbTemplate("{mc} did not move. {they_a} held {their_a} stance despite {their_a} body’s shaking. {they_a} listened for any sound of movement, but even the rustle of {thing1}s in the wind had dwindled. \nThe lone hanging lightbulb of the {place1} flickered. Then it went dark. \nEyes still adjusting to the sudden darkness, {mc} sensed the {person1}’s presence. In a matter of seconds {they_a} had the rifle propped once again against his shoulder. Trusting his instincts, {mc} steadied {them_a}self, aimed into the darkness, and shot. The recoil shuddered through {their_a} {adj1} body. {they_a} blinked and made out the shape of the {adj} {person1} in front of {them_a}— now hunched and producing a sort of whining sound. \n{mc} ran.\n{their_a} feet were sore, there were {thing2}s stuck in {their_a} shoes from the {place1}. {their_a} shoulder ached from the pressure of the gunshot. Despite every protest of {their_a} body, {mc} ran. {they_a} pushed past {their_a} tiring muscles and panicked thoughts. {they_a} let {their_a} legs take {them_a} into the {place_b}, to the place {they_a} always ended up when he ran away.", 
            new List<TemplateSlot>
            {
